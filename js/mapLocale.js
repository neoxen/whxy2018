...
var locs = [
    [{name:'湖北'}, {name:'武汉',value:100}],
    [{name:'江西'}, {name:'南昌',value:40}],
    [{name:'湖北'}, {name:'宜昌',value:40}],
    [{name:'北京'}, {name:'北京',value:40}],
    [{name:'广东'}, {name:'深圳',value:100}],
...
var series = [];
[['1998', Data1998], ['2010', Data2010],['2012', Data2012],['2013', Data2013],['2014', Data2014], ['2018', Data2018]].forEach(function (item, i) {
    series.push({
            name: '武汉信用（' + item[0] + '年）',
            type: 'lines',
...
option = {
    ...
    legend: {
        ...
        top: 'top',
        left: 'left',
        data:['武汉信用（1998年）', '武汉信用（2010年）','武汉信用（2012年）','武汉信用（2013年）','武汉信用（2014年）', '武汉信用（2018年）'],
        textStyle: {
            color: '#fff'
        },
        selectedMode: 'single'
...
setInterval(function () {
    myChart.setOption({
        bmap: {
            center: geoCoordMap[locs[currentLoc][1].name],
            zoom: 6,
            roam: false,
            mapStyle: {
                styleJson: [
        ...
        series: {
            ...
            data: [
                {
                    name: locs[currentLoc][1].name,
                    value: geoCoordMap[locs[currentLoc][1].name].concat([locs[currentLoc][1].value])
                }
            ]

        }
    });
    currentLoc = (currentLoc + 1) % locs.length;
}, 4000);
